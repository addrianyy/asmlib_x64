#include "AssemblerEncoding.hpp"

using namespace asmlib;

#define EXPORT_ENCODING(name) const FullInstructionEncoding* _asm_##name##_encoding = &name;
#define EXPORT_ENCODING_CUSTOM_NAME(name, encoding)                                                \
  const FullInstructionEncoding* _asm_##name##_encoding = &encoding;
#define MAKE_ARRAY_2(a, b)                                                                         \
  { a, b }
...
STANDALONE_INSTRUCTION(rdtsc, MAKE_ARRAY_2(0x0f, 0x31))
...
EXT_INSTRUCTION(movzxb, RexwMode::Usable, Prefix66Mode::Usable, MAKE_ARRAY_2(0x0f, 0xb6), true)
EXT_INSTRUCTION(movzxw, RexwMode::Usable, Prefix66Mode::Unusable, MAKE_ARRAY_2(0x0f, 0xb7), false)
EXT_INSTRUCTION(movsxb, RexwMode::Usable, Prefix66Mode::Usable, MAKE_ARRAY_2(0x0f, 0xbe), true)
EXT_INSTRUCTION(movsxw, RexwMode::Usable, Prefix66Mode::Unusable, MAKE_ARRAY_2(0x0f, 0xbf), false)
